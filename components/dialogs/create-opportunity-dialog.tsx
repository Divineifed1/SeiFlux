      ...
      <DialogContent className="sm:max-w-[520px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              <DialogTitle className="text-base">Create opportunity</DialogTitle>
              <DialogDescription className="text-xs mt-0.5">
                {projectName
                  ? `Post a contribution opportunity for ${projectName}.`
                  : 'Post a new contribution opportunity for your project.'}
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
